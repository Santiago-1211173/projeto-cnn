...
Identify the tool and route accordingly. Read full routing rules from [resources/tool-routing.md](resources/tool-routing.md).
Read full templates from [resources/templates.md](resources/templates.md) only for the category you need.
...
| File | Read When |
|------|-----------|
| [resources/tool-routing.md](resources/tool-routing.md) | You need the specific syntax constraints and features of the target tool. |
| [resources/templates.md](resources/templates.md) | You need the full template structure for any tool category |
| [resources/patterns.md](resources/patterns.md) | User pastes a bad prompt to fix, or you need the complete 35-pattern reference |
